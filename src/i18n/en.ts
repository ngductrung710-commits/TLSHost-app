...
export const EN: Record<string, string> = {
  ...
  /* ---- Drawer chi tiết đơn ---- */
  "ĐƠN {ma}": "BOOKING {ma}",
  "Chi tiết đặt phòng": "Booking details",
  "Đang tải…": "Loading…",
  "Lưu trú": "Stay",
  "Giảm giá": "Discount",
  "Phương thức": "Method",
  ...
  "Không tải được đặt phòng. Thử lại.": "Couldn't load the booking. Try again.",
  "Đặt giá cho đơn (ở ô tổng tiền) rồi mới ghi nhận thanh toán được.":
    "Set a price for this booking (in the total field) before recording a payment.",
  "Tổng tiền": "Total",
  "Đã thu": "Paid",
  "bởi {ai}": "by {ai}",
  ...
  "Đặt phòng": "Booking",
  "Chặn": "Block",
  "Bấm vào ô trống thì làm gì": "What an empty cell does",
  "Bấm vào ô trống để tạo đặt phòng.": "Click an empty cell to add a booking.",
  "Bấm vào ô trống để chặn đêm cho bảo trì.":
    "Click an empty cell to block the night for maintenance.",
  "Thêm đặt phòng — {phong}, {ngay}": "Add a booking — {phong}, {ngay}",
  "Chặn đêm — {phong}, {ngay}": "Block the night — {phong}, {ngay}",
  ...
  "Chú thích": "Legend",
  "Gọn": "Compact",
  "Khoá đêm": "Blocked night",
  "Mật độ hàng": "Row density",
  "Phóng to": "Zoom in",
  "Thoáng": "Comfortable",
  "Thu nhỏ": "Zoom out",
  "Thu phóng": "Zoom",
